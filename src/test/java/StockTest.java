...
import com.simeonbiniatidis.supersimplestock_maven_ut_03.StockType;
import com.simeonbiniatidis.supersimplestock_maven_ut_03.TradeType;
import com.simeonbiniatidis.supersimplestock_maven_ut_03.Stock;
import com.simeonbiniatidis.supersimplestock_maven_ut_03.Trade;
...
public class StockTest {
	...
	public void testCalculateVolumeWeightedStockPrice() {
		...
		stockALE.buy(2, 10.0);		
		Double volumeWeightedStockPrice = stockALE.calculateStockPriceByVolumeWeight();
		...
		volumeWeightedStockPrice = stockALE.calculateStockPriceByVolumeWeight();
		assertEquals(10.0, volumeWeightedStockPrice, 0.0);
	}
